 ...
 *
 * 시나리오:
 *   VU를 1500 → 2000 → 2500 → 3000 단계적으로 증가시켜
 *   에러율이 1%를 초과하거나 p(95)가 1000ms를 초과하는 한계 처리량을 찾는다.
 *
 *   이전(250 VU, think-time 0.3~1.3s) 대비 변경:
 *     - VU 12배 확대 (250 → 3000)
...
export default function () {
  ...
  // 1500 VU × (avg 217ms 응답 / avg 392ms 주기) ≈ 830 req 동시처리
  // 3000 VU × (avg 954ms 응답 / avg 1120ms 주기) ≈ 2556 req 동시처리
