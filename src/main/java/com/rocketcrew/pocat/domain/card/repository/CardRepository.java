...
public interface CardRepository extends JpaRepository<Card, Long>, CardRepositoryCustom {
    ...
    @Query("SELECT c FROM Card c WHERE c.category = com.rocketcrew.pocat.domain.card.entity.enums.CardCategory.POKEMON AND c.pokemon IS NULL ORDER BY c.id ASC")
    Page<Card> findPokemonCardsWithNullPokemon(Pageable pageable);
}
